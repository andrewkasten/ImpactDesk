...
GoodMorning, everyone. I'm glad to share with you this application. 

## **PART 2: What is this application solving? (00:30)**

I've done some fundraising and it's difficult. I am here trasitioning to a software. One of the challenges with fundraising is developing key relationships.For **nonprofit fundraising managers and development staff** who **need to organize in-person donor meetings, visits, and events more efficiently**, **ImpactDesk**is a **fundraising activity planner**a**lets users schedule relationship-building activities, filter them by day, and view addresses on a map for better planning**. Unlike **generic CRM systems,**our product **is built specifically for in-person donor relationship work and daily fundraising coordination**.
...
We've got user authentication with a name 
